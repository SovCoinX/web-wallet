...
let network = {
    messagePrefix: '\x19Sovereign Coin Signed Message:\n',
    bip32: {
        public: 0x0488b21e,
        private: 0x0488ade4
    },
...
function estimateTxFee(payAmount, fromAddresses, lockTxAmount, minConfirmations) {
    ...
    // FEE = 0.1 SOV per 1000 bytes
    // 1 UTXO == roughly 226 bytes
    // Therefore, 0.1 SOV per 6 selected UTXO's
    // To be safe, settle on 0.1 SOV per 5 UTXO's ??
